...
```json
  ...
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\SrSelfDeclaration\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrSelfDeclaration\x\GeneratePluginPhpAndXml; 
...
...
```json
  ...
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrSelfDeclaration\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrSelfDeclaration\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrSelfDeclaration\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrSelfDeclaration\x\UpdateVersion; 
...
