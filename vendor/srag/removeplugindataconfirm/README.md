...
```php
//...
use srag\RemovePluginDataConfirm\SrSelfDeclaration\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrSelfDeclaration\x\RepositoryObjectPluginUninstallTrait;
//...
