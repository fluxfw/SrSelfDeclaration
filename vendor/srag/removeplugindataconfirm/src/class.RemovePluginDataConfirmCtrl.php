...
use ilSession;
use ilUtil;
use srag\DIC\SrSelfDeclaration\DICStatic;
 ...
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\SrSelfDeclaration\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
